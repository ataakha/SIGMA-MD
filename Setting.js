...
global.owner = process.env.OWNER_NUMBER  || '92346690239' ;  // ADD YOUR NUMBER WITHOUT +
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '29_07_2024_SIGMA_MD_wy02Y8WQ_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
